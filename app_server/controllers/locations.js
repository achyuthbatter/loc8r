...
if(process.env.NODE_ENV === 'production'){
    apiOptions.server = 'https://limitless-chamber-23421.herokuapp.com';
}
...
const renderHomepage = (req,res, responseBody) => {
    ...
    res.render('locations-list', {
        ...
        sidebar: "Looking for wifi and a seat? Loc8r helps you find places to work when out and about."+
                "Perhaps with cofee, cake or a pint? Let Loc8r help you find the places you're looking for.",
...
const renderReviewForm = (req, res, review) => {
    res.render('location-review-form', {
        title: `Review ${review.name} in Loc8r`,
        pageHeader: { title: `Review ${review.name}`},
        error: req.query.err
    });
}
...
const locationInfo = (req,res) => {
    getLocationInfo(req, res, (req,res,responseData) => renderDetailsPage(req, res, responseData));      
};
